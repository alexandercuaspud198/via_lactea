...
const Events = () => {
  ...
  const getNextEventDate = () => {
    ...
    let eventDate = new Date(currentYear, 9, 11);
    if (now > eventDate) eventDate = new Date(currentYear + 1, 9, 11);
    return eventDate;
  };
  ...
  return (
    <section id="eventos" className="py-24 bg-page">
      <div className="container mx-auto px-6">
        ...
        {/* Countdown Section */}
        <div className="max-w-4xl mx-auto mb-16 reveal-scale stagger-2">
            ...
            >
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <h3 className="service-card-title mb-2">{event.name}</h3>
                  <p className="service-card-description mb-4">{event.description}</p>

                  <div className="space-y-2">
                    <div className="flex items-center space-x-2 text-sm text-secondary">
                      <MapPin size={14} /><span>Plaza Central de Guachucal</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm text-secondary">
                      <Users size={14} /><span>Evento familiar - Entrada libre</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm text-secondary">
                      <Clock size={14} /><span>9:00 AM - 6:00 PM</span>
                    </div>
                  </div>
                </div>
              </div>
